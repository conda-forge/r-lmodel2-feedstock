...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-lmodel2-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13769&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-lmodel2-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-lmodel2` can be installed with:

```
conda install r-lmodel2
```

It is possible to list all of the versions of `r-lmodel2` available on your platform with:
